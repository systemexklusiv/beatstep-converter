...
//        public final static String PAD_CHANNEL_STARTING_AT = "padChannelStartingAt";
        ...
        private static String getManual(String applicationNameBuildVersion) {
            return  System.lineSeparator() + System.lineSeparator()
                    + "-------------------------------------------- "
                    + System.lineSeparator() + System.lineSeparator()  + applicationNameBuildVersion + System.lineSeparator() + "Source code here: https://github.com/systemexklusiv" + System.lineSeparator() +System.lineSeparator() + "[ INSTRUCTIONS ]" + System.lineSeparator()
                ...
                + "Note that each option starts with a double minus followed by the name (better copy paste it!) and an equals symbol and a digit or a word or nothing" + System.lineSeparator() + System.lineSeparator()
                + "example: $ "+applicationNameBuildVersion+" --allChannel=0 --allPadToOptionSwitchedControl --source=source-source-preset.beatstep --target=target-source-preset.beatstep " + System.lineSeparator() + System.lineSeparator()
                ...
                + System.lineSeparator()
                + "You can use the beatstep-converter multiple time so you don't have to make all adjustments in one call, because the rest of assingments got unaltered piped through." + System.lineSeparator() +
                ...
                + PREFIX + ALL_CHANNEL + "=0 to 15 and 65 for the global-channel -> Sets the midichannel for all knobs and pads. thus 0-based. 0 means channel 1 and 15 channel 16" + System.lineSeparator()
                + PREFIX +  ALL_KNOB_CHANNEL + "=0 to 15 and 65 for the global-channel -> Sets the midichannel for all knobs. 0 means channel 1 and 15 channel 16" + System.lineSeparator()
        ...
        public static String manual( String applicationName, String buildVersion) {
            return getManual(applicationName + "-" + buildVersion);
